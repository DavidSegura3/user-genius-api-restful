...
import com.nisum.api.cl.infrastructure.adapters.security.SimpleGrantedAuthorityJsonCreator;
...
public class JwtValidationFilter extends BasicAuthenticationFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        String header = request.getHeader(HEADER_AUTHORIZATION.getValue());

        if (header == null || !header.startsWith(PREFIX_TOKEN.getValue())) {
        ...
        try {
            ...
            Object authoritiesClaims = claims.get(AUTHORITIES.getValue());
